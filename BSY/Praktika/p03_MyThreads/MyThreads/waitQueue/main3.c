...
int main (int argc, char *argv[]) {
    ...
    mthreadCreate(thread1, theThread, (void *)0, prio[0], STACK_SIZE);
    mthreadCreate(thread2, theThread, (void *)1, prio[1], STACK_SIZE);
    mthreadCreate(thread3, theThread, (void *)2, prio[2], STACK_SIZE);
...
void* theThread(void* ptr) {                    // user defined thread function
    int nr = (int)((long)ptr);
    ...
    // first thread that exits for-loop -> stops all other threads
    stop = 1;   
