...
public class Briefprogramm {
	...
	public static void main(String[] args) {
		...
		Adresse adresseSender = new Adresse("VornameSender", "NameSender", "Senderstrasse", 2, 8001, "MusterortSender");
		...
		empfaengerList.add(
				new Adresse("VornameEmpfänger1", "NameEmpfänger1", "Empfängerstrasse", 1, 8001, "MusterortEmpfänger"));
		empfaengerList.add(
				new Adresse("VornameEmpfänger2", "NameEmpfänger2", "Empfängerstrasse", 2, 8002, "MusterortEmpfänger"));
		empfaengerList.add(
				new Adresse("VornameEmpfänger3", "NameEmpfänger3", "Empfängerstrasse", 3, 8003, "MusterortEmpfänger"));

		BriefdruckStrategie standardBriefdruck = new KonsoleDrucken();
		BriefdruckStrategie fensterBriefdruck = new KonsoleDrucken();
