...
public class Spiel 
{
    ...
    private void raeumeAnlegen()
    {
         ...
         * 
         * Key vom HashMap ist mit eine entprechende Schlüssel verbunden bzw. Ausgang.
         */
        draussen.setzeAusgaenge("draussen", draussen);
        hoersaal.setzeAusgaenge("hoersaal", hoersaal); 
        cafeteria.setzeAusgaenge("cafeteria", cafeteria);
        labor.setzeAusgaenge("labor", labor);
        buero.setzeAusgaenge("buero", buero);
    ...
    private void rauminfoAusgeben() {
    	System.out.println("Sie sind " + aktuellerRaum.gibLangeBeschreibung());
        System.out.print("Ausgänge: ");
        aktuellerRaum.printExits();
        System.out.println();
    }
    ...
    private void wechsleRaum(Befehl befehl) 
    {
        ...
        naechsterRaum = aktuellerRaum.gibAusgang(richtung);
