...
/**
* @brief Calculate the grade average of the class
* @param sumMarks
* @param totalStudents
* @return averageMark
*/
...
/**
* @brief Creates the Statistic including the printing function
...
/**
* @brief Main function for starting the program
*/
int main(void){
