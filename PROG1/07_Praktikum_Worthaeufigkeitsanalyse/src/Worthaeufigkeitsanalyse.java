...
public class Worthaeufigkeitsanalyse {
	...
	public HashMap<String, Integer> getWoerterHaeufigkeit() {
	 ...
	 */
	void verarbeiteText(String text) {
		if (text != null) {
	...
	public void druckeStatistik() {
		for (Entry<String, Integer> wortHaeufigkeit : woerterHaeufigkeit.entrySet()) {
	...
	public static void main(String[] args) {
		...
		hauefigkeitsanalyse.verarbeiteText(
				"John fuegt hinzu, dass die Softwareentwicklung nicht nur aus Programmieren bestehe, sondern es sich dabei um einen komplexen Prozess, bestehend aus vielen kleinen Komponenten, handelt.\"");
