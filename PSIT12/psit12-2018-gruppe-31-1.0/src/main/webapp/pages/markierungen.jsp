...
<head>
  <title>Erstellte Markierungen</title>
  <meta charset="utf-8">
  ...
  <link rel="stylesheet" href="../css/markierungen.css">
  ...
  <body>
    <div class="wrapper">
      ...
      <div class="content">
        ...
        <h3>Erstellte Markierungen</h3>
        <div id="markerList" class="border border-dark">
          <div class="markerEntry">
            <%
              userController.loadCreatedMarkers();
              List<Marker> createdMarkers = userController.getCreatedMarkers();

              // If no user is not logged in
              if(userController.getUser().getId() == -1) {
            %>
            <p class="m-3 container-fluid">Sie müssen angemeldet sein, um Ihre erstellten Markierungen zu sehen.</p>
            <%
            }
            // If no markers are favourited
            else if(createdMarkers.isEmpty()) {
            %>
            <p class="m-3 container-fluid">Es wurden keine Markierungen erstellt.</p>
            <%
            }
            // print markers
            else {
            ...
            <div class="markerEntry mb-2 container-fluid">
              <div class="row">
                <h4 class="col"><%=marker.getName()%></h4>
              </div>
              <div class="row">
