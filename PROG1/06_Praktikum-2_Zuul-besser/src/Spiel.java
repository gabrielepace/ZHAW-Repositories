...
public class Spiel {
	...
	/**
	 * Baut die Spielewelt auf. Erzeugt die Raeume mit Verbindungen und fuellt diese
	 * mit Personen und Gegenstaenden.
	 */
	...
	/**
	 * Verteilt eine Anzahl Gegenstaende auf eine Liste von Raeumen. Die Zuteilung
	 * erfolgt auf Basis einer Zufallsstrategie.
	 * 
	 * @param raum Liste der Raeume
	 */
	...
	private void willkommenstextAusgeben() {
		...
		System.out.println("Tippen sie '" + Befehlswort.HILFE + "', wenn Sie Hilfe brauchen.");
		System.out.println();
	...
	/**
	 * Packt den spezifizierten Gegenstand in den Rucksack des Spielers und entfernt
	 * ihn aus dem aktuellen Raum.
	 * 
	...
	private void gegenstandEinpacken(int nummer) {
		...
		if (gegenstand == null) {
			...
			if (spieler.gibTragkraft() >= rucksack.berechneGewicht(rucksack.getRucksack()) + gegenstand.gibGewicht()) {
				System.out.println("Gegenstand eingepackt: " + gegenstand.gibName());
				rucksack.getRucksack().add(gegenstand);
			} else {
	...
	/**
	 * Uebernimmt, falls vorhanden, die Kontrolle der Person mit der spezifizierten
	 * Nummer.
	 * 
	...
	private void befehleAusgeben() {
		...
		System.out.println(Befehlswort.gibBefehlsworteAlsText() + " (klein geschrieben)");
	}

	/**
	 * Versuche, in eine Richtung zu gehen. Wenn es einen Ausgang gibt, wechsele in
	...
	/**
	 * Der Befehl zum Beenden wurde eingegeben. Ueberpruefe den Rest des Befehls, ob
	 * das Spiel wirklich beendet werden soll.
	 * 
	 * @return 'true', wenn der Befehl das Spiel beendet, 'false' sonst.
	 */
