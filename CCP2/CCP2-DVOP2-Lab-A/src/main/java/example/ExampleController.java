...
import org.springframework.stereotype.Controller; //new
...
public class ExampleController {
    ...
    public String weather() {
        return weatherClient.fetchWeather()
                ...
                .orElse("Sorry, I couldn't fetch the weather for you :( - weatherClient.toString(): "+weatherClient.toString()); //new2  
    }
}
